...
from .u2f_handler import U2FDeviceHandler, U2FRegisterHandler, U2FAuthHandler
...
__all__ = ['BaseHandler', 'IndexHandler', 'TrustHandler', 'ArticleHandler',
           ...
           'StaticHandler', 'AuthHandler', 'U2FDeviceHandler',
           'U2FRegisterHandler', 'U2FAuthHandler', 'NotFoundHandler']
